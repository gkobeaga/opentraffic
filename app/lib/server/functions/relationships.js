...
set_lord_and_vassal = function(winner_id, loser_id) {
	...
	if (loser.king) {
		Cue.addTask('updateKingChatroom', {isAsync:false, unique:true, delay:500}, {user_id:loser.king});
	}
	Cue.addTask('updateKingChatroom', {isAsync:false, unique:true, delay:500}, {user_id:loser._id});
	Cue.addTask('cleanupAllKingChatrooms', {isAsync:false, unique:true, delay:1000}, {});
