Meteor.publish('left_panel_allies', function() {
	if(this.userId) {
		...
		var cur = Meteor.users.find({allies_above: this.userId}, {fields: fields});
...
Meteor.publish('left_panel_villages', function() {
	if(this.userId) {
		var sub = this;
		var fields = {name:1, x:1, y:1, user_id:1, level:1, "income.worth":1, under_construction:1, constructionStarted:1};
